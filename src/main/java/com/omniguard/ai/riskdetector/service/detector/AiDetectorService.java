...
public class AiDetectorService {
    ...
    public Map<String, Object> detectSingleText(String textContent) throws IOException, InterruptedException {
        ...
        return serverTaskService.executeTask("DetectSingleText", "Detect and return the ai analysis of the content.", CapabilityType.LLM_CHAT, CapabilityLocation.REMOTE, modelChatRequest);
    }
